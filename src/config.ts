...
export const siteConfig: SiteConfig = {
	title: "郭师傅 の 技术宅",
	subtitle: "闲言小阁",
	siteURL: "https://www.mgstudio.icu/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-02-06", // 站点开始运行日期，用于站点统计组件计算运行天数
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	meting_api:
		"https://musicapi.mgstudio.icu/api?server=:server&type=:type&id=:id&auth=:auth&r=:r", // Meting API 地址
	id: "17737635146", // 歌单ID
